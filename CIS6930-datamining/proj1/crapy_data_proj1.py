...
for each in countries:
	c2c[each['name']] = each['continent']

#process table from wiki
wiki_url = "https://en.wikipedia.org/wiki/List_of_countries_by_life_expectancy"
repsponce = req.get(wiki_url, headers=user_agent)
soup = bs(repsponce.text, "html.parser")
...
<tr>
<td>1</td>
<td><span class="flagicon"><img alt="" class="thumbborder" data-file-height="600" data-file-width="750" height="15" src="//upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Flag_of_Monaco.svg/19px-Flag_of_Monaco.svg.png" srcset="//upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Flag_of_Monaco.svg/29px-Flag_of_Monaco.svg.png 1.5x, //upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Flag_of_Monaco.svg/38px-Flag_of_Monaco.svg.png 2x" width="19"/> </span><a href="/wiki/Monaco" title="Monaco">Monaco</a></td>
<td>89.5</td>
<td>85.6</td>
<td>93.5</td>
</tr>
...
<img alt="" class="thumbborder" data-file-height="600" data-file-width="900" height="15" src="//upload.wikimedia.org/wikipedia/en/thumb/9/9e/Flag_of_Japan.svg/23px-Flag_of_Japan.svg.png" srcset="//upload.wikimedia.org/wikipedia/en/thumb/9/9e/Flag_of_Japan.svg/35px-Flag_of_Japan.svg.png 1.5x, 
//upload.wikimedia.org/wikipedia/en/thumb/9/9e/Flag_of_Japan.svg/45px-Flag_of_Japan.svg.png 2x" width="23"/> </span><a href="/wiki/Japan" title="Japan">Japan</a></td>
<td>85</td>
<td>81.7</td>
<td>88.5</td>
</tr>
...
for each in trs:
	temp=[]
	#table head
	ths = each.findChildren('th')
	if len(ths) > 0:
		for th in ths:
			th_list.append(th.text)
		th_list.append("continent")
	#table body
	tds = each.findChildren('td')
	if len(tds) > 0:
		ct = None
...
#output
with open("project1_data.csv", "w", newline='', encoding='utf-8') as f:
	writer = csv.writer(f)
